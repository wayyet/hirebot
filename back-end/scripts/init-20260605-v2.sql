...
CREATE TABLE "Conversations" (
    "ConversationId" character varying(120) NOT NULL,
...
CREATE TABLE "Messages" (
    "MessageId" character varying(120) NOT NULL,
    "ConversationId" character varying(120) NOT NULL,
    "InstanceId" character varying(120) NOT NULL,
    "TenantId" character varying(128) NOT NULL,
    ...
    "Channel" character varying(40) NOT NULL,
    "ExternalMessageId" character varying(160),
    "ExternalUserId" character varying(160),
    "DeliveryStatus" character varying(40),
...
CREATE INDEX "IX_Conversations_InstanceId_OwnerUserId_Channel" ON "Conversations" ("InstanceId", "OwnerUserId", "Channel");

CREATE INDEX "IX_Conversations_TenantId_UpdatedAt" ON "Conversations" ("TenantId", "UpdatedAt");
...
CREATE UNIQUE INDEX "IX_Messages_Channel_ExternalMessageId" ON "Messages" ("Channel", "ExternalMessageId");

CREATE INDEX "IX_Messages_ConversationId_CreatedAt" ON "Messages" ("ConversationId", "CreatedAt");

CREATE INDEX "IX_Messages_InstanceId_Channel_CreatedAt" ON "Messages" ("InstanceId", "Channel", "CreatedAt");

CREATE INDEX "IX_Messages_InstanceId_CreatedAt" ON "Messages" ("InstanceId", "CreatedAt");
...
VALUES ('20260605050822_InitialCreate_20260605', '10.0.7');
