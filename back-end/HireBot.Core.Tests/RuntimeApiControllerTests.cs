...
public sealed class RuntimeApiControllerTests
{
    ...
    private sealed class FakeEvaluationService : IEvaluationService
    {
        ...
        public Task<ApiResponse<EvaluationReportContentUploadResultDto>> UploadReportContentAsync(string employeeId, EvaluationReportContentUploadRequestDto request, CancellationToken cancellationToken = default) => throw new NotSupportedException();
