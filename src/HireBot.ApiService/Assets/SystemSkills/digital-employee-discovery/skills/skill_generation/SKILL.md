---
<<<<<<<< HEAD:src/HireBot.ApiService/Assets/SystemSkills/employment-coach-conversation/skill-generation/SKILL.md
...
>>>>>>>> 55b9227ba124696b492fd60ba42dda25d7be1817:src/HireBot.ApiService/Assets/SystemSkills/digital-employee-discovery/skills/skill_generation/SKILL.md
...
<<<<<<<< HEAD:src/HireBot.ApiService/Assets/SystemSkills/employment-coach-conversation/skill-generation/SKILL.md
当用户要求根据雇佣教练阶段二系统 todo、描述、Markdown、文本、JSON、YAML 或 zip 文件创建、更新、合并、规范化业务技能包时，使用本技能。
========
...
<<<<<<<< HEAD:src/HireBot.ApiService/Assets/SystemSkills/employment-coach-conversation/skill-generation/SKILL.md
- 雇佣教练 todo：由上游 `employment-coach-conversation` 通过 `<dispatch target=skill-generation>` 指定的结构化系统 todo。
========
...
<<<<<<<< HEAD:src/HireBot.ApiService/Assets/SystemSkills/employment-coach-conversation/skill-generation/SKILL.md
- todo 路径：输入包含 `target_skill: skill-generation` 的系统 todo，且 payload 已含 `skill_name`、`skill_description`、`trigger`、`expected_output`。
========
...
<<<<<<<< HEAD:src/HireBot.ApiService/Assets/SystemSkills/employment-coach-conversation/skill-generation/SKILL.md
- todo：保留 todo id、intent、payload、source、acceptance，写入 `references/source-digest.md` 的 todo source 区块。
========
