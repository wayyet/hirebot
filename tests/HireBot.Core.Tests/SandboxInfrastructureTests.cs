...
public sealed class SandboxInfrastructureTests
{
    ...
    public async Task SandboxService_SendMessageAsync_WithTwoAttachments_ShouldInjectTwoFileMarkers()
    {
        ...
        Assert.Contains("[FILE_URL:/media/media-001]", handler.LastChatCompletionContent!, StringComparison.Ordinal);
        Assert.Contains("[FILE_URL:/media/media-002]", handler.LastChatCompletionContent!, StringComparison.Ordinal);
